  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-1 bg-white border-[4px] border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] p-1 w-fit" data-tour="leads-view-switcher">
          {VIEWS.map(v => (
